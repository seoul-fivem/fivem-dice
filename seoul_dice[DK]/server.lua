...
vRP.defInventoryItem({"dice", "terning", "<img src='https://cdn.discordapp.com/attachments/718420494755430481/722683584170819624/download.jpg' height='200' width='200' />", function(args) 
    local choices = {}
	...
	choices["*brug"] = {function(player,choice,mod)
        ...
        if user_id ~= nil then
          --  vRP.tryGetInventoryItem({user_id, "dice", 1, true}) 
            ...
            vRPclient.notify(player,{"Kaste terningerne."} ) 
